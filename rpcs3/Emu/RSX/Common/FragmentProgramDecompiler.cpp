...
bool FragmentProgramDecompiler::handle_tex_srb(u32 opcode)
{
	...
	{
		AddTex();
		insert_texture_fetch({FUNCTION::FUNCTION_TEXTURE_SAMPLE1D, FUNCTION::FUNCTION_TEXTURE_SAMPLE2D, FUNCTION::FUNCTION_TEXTURE_SAMPLECUBE, FUNCTION::FUNCTION_TEXTURE_SAMPLE3D,
		    FUNCTION::FUNCTION_TEXTURE_SHADOW2D, FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_DEPTH_RGBA});
	...
	case RSX_FP_OPCODE_TXP:
	{
		...
		AddTex();
		insert_texture_fetch({FUNCTION::FUNCTION_TEXTURE_SAMPLE1D_PROJ, FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_PROJ, FUNCTION::FUNCTION_TEXTURE_SAMPLECUBE_PROJ, FUNCTION::FUNCTION_TEXTURE_SAMPLE3D_PROJ,
		    FUNCTION::FUNCTION_TEXTURE_SHADOW2D_PROJ, FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_DEPTH_RGBA_PROJ});
	...
	case RSX_FP_OPCODE_TXD:
	{
		...
		if (m_prog.redirected_textures & (1 << dst.tex_num) || m_prog.shadow_textures & (1 << dst.tex_num))
		{
		...
		insert_texture_fetch({FUNCTION::FUNCTION_TEXTURE_SAMPLE1D_GRAD, FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_GRAD, FUNCTION::FUNCTION_TEXTURE_SAMPLECUBE_GRAD, FUNCTION::FUNCTION_TEXTURE_SAMPLE3D_GRAD,
		    FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_GRAD, FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_GRAD});
	...
	{
		AddTex();
		insert_texture_fetch({FUNCTION::FUNCTION_TEXTURE_SAMPLE1D_BIAS, FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_BIAS, FUNCTION::FUNCTION_TEXTURE_SAMPLECUBE_BIAS, FUNCTION::FUNCTION_TEXTURE_SAMPLE3D_BIAS,
	...
	{
		AddTex();
		insert_texture_fetch({FUNCTION::FUNCTION_TEXTURE_SAMPLE1D_LOD, FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_LOD, FUNCTION::FUNCTION_TEXTURE_SAMPLECUBE_LOD, FUNCTION::FUNCTION_TEXTURE_SAMPLE3D_LOD,
		    FUNCTION::FUNCTION_TEXTURE_SHADOW2D, // Shadow and depth_rgba variants are generated for framebuffers where only LOD0 exists
		    FUNCTION::FUNCTION_TEXTURE_SAMPLE2D_DEPTH_RGBA});
