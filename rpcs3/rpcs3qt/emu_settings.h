...
private:
	...
	const QMap<SettingsType, cfg_location> SettingsLoc =
	{
		...
		{ ApproximateXFloat,        { "Core", "Approximate xfloat"}},
		...
		{ SPU_FCGT_Accuracy,		{ "Core", "FCGT accuracy"}},
		{ SPU_FCMGT_Accuracy,		{ "Core", "FCMGT accuracy"}},
		{ SPU_FM_Accuracy,			{ "Core", "FM accuracy"}},
		{ SPU_FNMS_Accuracy,		{ "Core", "FNMS accuracy"}},
		{ SPU_FMA_Accuracy,			{ "Core", "FMA accuracy"}},
		{ SPU_FMS_Accuracy,			{ "Core", "FMS accuracy"}},
		{ SPU_FREST_Accuracy,		{ "Core", "FREST accuracy"}},
		{ SPU_FRSQEST_Accuracy,		{ "Core", "FRSQEST accuracy"}},
		{ SPU_FI_Accuracy,			{ "Core", "FI accuracy"}},
		{ SPU_FA_Accuracy,			{ "Core", "FA accuracy"}},
		{ SPU_FS_Accuracy,			{ "Core", "FS accuracy"}},
		{ SPU_FESD_Accuracy,		{ "Core", "FESD accuracy"}},
		{ SPU_FRDS_Accuracy,		{ "Core", "FRDS accuracy"}},
		{ SPU_FCEQ_Accuracy,		{ "Core", "FCEQ accuracy"}},
		{ SPU_FCMEQ_Accuracy,		{ "Core", "FCMEQ accuracy"}},
		{ SPU_CFLTS_Accuracy,		{ "Core", "CFLTS accuracy"}},
		{ SPU_CFLTU_Accuracy,		{ "Core", "CFLTU accuracy"}},
		{ SPU_CSFLT_Accuracy,		{ "Core", "CSFLT accuracy"}},
		{ SPU_CUFLT_Accuracy,		{ "Core", "CUFLT accuracy"}},
